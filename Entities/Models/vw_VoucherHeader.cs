...
[Keyless]
public partial class vw_VoucherHeader
{
    [StringLength(26)]
    ...
    [StringLength(79)]
    [Unicode(false)]
    public string? voucherLifeSpan { get; set; }
    ...
    [Column(TypeName = "datetime")]
    public DateTime? lineItemProdDate { get; set; }

    [Column(TypeName = "datetime")]
    public DateTime? lineitemExpiryDate { get; set; }

    [StringLength(79)]
    [Unicode(false)]
    public string? lineItemLifeSpan { get; set; }
